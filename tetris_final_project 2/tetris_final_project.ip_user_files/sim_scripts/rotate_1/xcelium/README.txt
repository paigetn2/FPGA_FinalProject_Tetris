...
#
# Generated by export_simulation on Thu May 07 21:53:14 -0500 2026
#
################################################################################
...
'-reset_run' switch to the './rotate.sh' script.
...
./rotate.sh -noclean_files

For more information on the script, please type './rotate.sh -help'.
