...
# IP: ip/row_cleared_1/row_cleared.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==row_cleared || ORIG_REF_NAME==row_cleared} -quiet] -quiet

# IP: ip/rotate_1/rotate.xci
set_property KEEP_HIERARCHY SOFT [get_cells -hier -filter {REF_NAME==rotate || ORIG_REF_NAME==rotate} -quiet] -quiet
...
# XDC: c:/Users/halderp/tetris_final_project/tetris_final_project.gen/sources_1/bd/design_1/design_1_ooc.xdc
